...
- Configure Guardian
- Update router
- User controllers, views and controller tests generated by mix phx.gen.auth as basis for implementing JWTs for user_registration, user_login, and user_reset_password JSON endpoints.
...
**User Login Controller Test**
```elixir
# test/my_app_web/controllers/json_api/user_login_controller_test.exs
...
```elixir
# lib/my_app_web/controllers/json_api/user_login_controller.ex
...
**User Login View**
```elixir
# lib/my_app_web/views/json_api/user_login_view.ex
